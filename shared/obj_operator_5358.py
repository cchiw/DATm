...
#copies from obj_operator_5381.py
...
op_negation = operator(True,-1,"neg", 1,"-", place_left, limit_none, False)
op_copy= operator(True,-1,"copy", 1,"", place_left, limit_none, False)
op_norm = operator(True,-1,"norm", 1, (u'|',u'|'), place_split, limit_none, False)
...
id=id+len(op_reg)
#----------------- binary -----------------
op_add = operator(True,-1,"addition", 2,"+", place_middle, limit_none, False)
op_subtract = operator(True,-1,"subtraction", 2, "-", place_middle, limit_none, False)
op_scale = operator(True,-2,"multiplication", 2, u'*', place_middle, limit_none, False)
op_division = operator(True,-3,"division", 2, u'/', place_middle, limit_small, False)
...
id=id+len(op_binary)
#----------------- trig -----------------
op_cosine = operator(True,-1, "cosine", 1, u'cos', place_left, limit_none, True)
op_sine = operator(True,-1, "sine", 1, u'sin', place_left, limit_none, True)
...
op_acosine = operator(True,-2, "arccosine", 1,  (u'acos(0.01*', u')'), place_split, limit_trig, True)
op_asine = operator(True,-3, "arcsine", 1,  (u'asin(0.01*', u')'), place_split, limit_trig, True)
#note sqrt is 'sqrt' in each branch
#op_sqrt = operator(True,id+4, "sqrt", 1, (u'sqrt(|', u'|)'), place_split, limit_nonzero, False)
op_sqrt = operator(True,-4, "sqrt", 1, (u'sqrt(', u')'), place_split, limit_nonzero, False)
op_atangent = operator(True,-5, "arctangent", 1, u'atan', place_left, limit_none, True)
op_tangent = operator(True,-6, "tangent", 1, u'tan', place_left, limit_none, True)
...
op_zeros_add22 = operator(True,-1, "zeros_add", 1, (u'(zeros[2, 2]+', u')'), place_split, limit_none, False)
op_zeros_scale3 = operator(True,-1, "zeros_scale", 1, (u'(', u'*zeros[3, 3])'), place_split, limit_none, False)
...
op_concat2 = operator(True,-4,"concat2", 2,"concat", place_left, limit_none, True)

...
op_max = operator(False,-1,"max", 2,"maxF", place_left, limit_none, True)
op_min = operator(False,-1,"min", 2,"minF", place_left, limit_none, True)
op_concat2 = operator(False,-2,"concat2", 2,"concat", place_left, limit_none, True)

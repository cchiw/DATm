...
void callDiderot_ex1(char *Outfile, int type, void *valF0, void *valF1, void *valF2){
    ...
    if (ex1_input_set_FF0 (wrld, valF0)) {
        fail ("unable to initialize imgRed", wrld);
    }
    if (ex1_input_set_FF1 (wrld, valF1)) {
        fail ("unable to initialize imgRed", wrld);
    }
    if (ex1_input_set_FF2 (wrld, valF2)) {
        fail ("unable to initialize imgRed", wrld);
    }
